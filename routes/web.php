...
Route::middleware(['auth', 'tenant'])->group(function () {
    ...
    Route::put('settings', [SettingsController::class, 'update'])->middleware(['permission:settings.manage', 'throttle:sensitive-admin'])->name('settings.update');
    Route::get('settings/subscriptions', [SubscriptionController::class, 'index'])->middleware('role:SUPER_ADMIN|Super Admin')->name('settings.subscriptions.index');
    Route::put('settings/hotels/{hotel}/subscription', [SubscriptionController::class, 'update'])->middleware(['role:SUPER_ADMIN|Super Admin', 'throttle:sensitive-admin'])->name('settings.subscriptions.update');
