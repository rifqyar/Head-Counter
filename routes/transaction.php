...
Route::middleware(['auth', 'ajax'])->group(function(){
    ...
    Route::prefix('meeting-attendance')->group(function(){
        Route::get('/', [MeetingAttendanceController::class, 'index'])->name('masterdata.meeting-attendance')->middleware('can:Meeting Attendance');
        Route::get('/add', [MeetingAttendanceController::class, 'create'])->name('meeting-attendance.add')->middleware('can:meeting.add');
        ...
        Route::get('/data/{id}', [MeetingAttendanceController::class, 'edit'])->name('meeting-attendance.edit')->middleware('can:meeting.edit');
    });
});
?>
