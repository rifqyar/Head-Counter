...
- COMPLETED: Fixed Select2 duplicate dropdown rendering in the booking wizard by destroying existing Select2 instances on inputs before jquery.steps reorganizes the DOM, and re-initializing them afterward.
